  ...
  const Stats = () => {
    return (
      <Box className={classes.root}>
        ...
        {unstakeAvailable &&  <Box display="flex" padding="18px 24px" justifyContent="space-between" alignItems="center" marginTop="6%" className={classes.unstakeAvailableContainer}>
          <Box>
